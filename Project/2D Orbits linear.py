...
def dSdt(t, S):
    x, v_x, y, v_y, z, v_z = S
    dSdt = [v_x, 2*n*v_y + 3*n**2*x, v_y, -2*n*v_x, v_z, -n**2*z]
    return dSdt
...
anim_orbits_hill(t, save_path='hill_animation_firstmode.gif')


# In[6]:


anim_orbits_inertial(t, save_path='eci_animation_firstmode.gif')
...
anim_orbits_hill(t, save_path='hill_animation_secondmode.gif')


# In[9]:


anim_orbits_inertial(t, save_path='eci_animation_secondmode.gif')
...
x_0 = 0 #must be small for the approximation be true
...
anim_orbits_hill(t, save_path='hill_animation_thirdmode.gif')


# In[23]:


anim_orbits_inertial(t, save_path='eci_animation_thirdmode.gif')
